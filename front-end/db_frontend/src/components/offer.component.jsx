...
export default function OfferComponent(props) {
    ...
    return (
        <section className="bg-white mt-4 mb-8 pt-4 shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out dark:bg-gray-700 rounded-2xl text-left flex px-auto items-center justify-center">
            <div className=" mx-auto h-48">
                ...
                {/*    </dd>*/}
                {/*</dl>*/}
                <dl className="flex items-center space-x-2 pt-8">
                    <div>
                        <dt className="mb-2 text-lg font-semibold leading-none text-gray-900 dark:text-white">Category</dt>
                        <dd className="text-lg font-light text-gray-500 sm:mb-5 dark:text-gray-400">{props.category}</dd>
                    </div>
                </dl>
