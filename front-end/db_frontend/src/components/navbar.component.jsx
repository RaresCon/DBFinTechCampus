...
import {MdOutlineBrightness4} from "react-icons/all.js";
...
export default function NavbarComponent(props) {
    ...
    const getNotification = () => {
        ...
        axios.post("http://localhost:8000/user/wallet", send)
            .then((res) => {
                console.log(res);
                setNotification(res.data.messages);
            })
            .catch(err => {
                console.log(err)
            })
            ...
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                <div className="flex flex-wrap justify-between items-center">
                    <div className="flex justify-start items-center">
                        <button id="toggleSidebar" aria-expanded="true" aria-controls="sidebar" onClick={props.sidebar}
                        ...
                        <Link to="/home" className="flex mr-4">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7b/Deutsche_Bank_logo_without_wordmark.svg/1200px-Deutsche_Bank_logo_without_wordmark.svg.png" className="mr-3 h-8"
                                 alt="FlowBite Logo"/>
                            <span
                                className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">DB Student</span>
                        </Link>
                    ...
                    <div className="flex items-center lg:order-2">
                        <button type="button" data-modal-toggle="defaultModal" id="defaultModalButton" onClick={props.modal}
                        ...
                        <div onClick={getNotification}
                            ...
                            <div>
                                {notification != null && notification.map(item => {
                                    return <a className="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                                        <div className="pl-3 w-full">
                                            <div className="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                                                <span
                                                    className="font-semibold text-gray-900 dark:text-white">{item}</span>
                                            </div>
                                            <div className="text-xs font-medium text-primary-700 dark:text-primary-400">10
                                                minutes ago
                                            </div>
                                        </div>
                                    </a>
                        ...
                        <button type="button" data-dropdown-toggle="apps-dropdown" onClick={props.darkmode}
                                className="p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
                            <span className="sr-only">View notifications</span>
                            <MdOutlineBrightness4 className="w-5 h-5"/>
                        ...
                        <button type="button"
                            ...
                            <Avatar alt={cookies.token.email.toUpperCase()} />
                        </button>
                        <div
                            ...
                            <div className="py-3 px-4">
                                <span
                                    className="block text-sm font-bold   text-gray-500 truncate dark:text-gray-400">{cookies.token.email}</span>
                            </div>
                            <ul className="py-1 font-light text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                                <li>
                                    <Link to="/home/wallet"
                                       className="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">My
                                        wallet</Link>
                                </li>
                                <li>
                                    <a
                                       className="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">Tokens: {props.tokens != null ? props.tokens.coins : 0}</a>
                                </li>
                            </ul>
                            <ul className="py-1 font-light text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                                <li>
